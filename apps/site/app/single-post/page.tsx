...
const SinglePost = () => {
   return (
      <Fragment>
         <section className=" container mx-auto px-5 md:px-0 w-full md:w-10/12 lg:w-5/12 font-work">
            <div className="py-5">
            ...
            <div className="font-serif">
               <div className="mt-8">
                  <p className="text-xl text-base-content/80">
                     ...
                     interacting with locals. Learning a few phrases in the
               ...
               <div className="p-8 bg-base-200 rounded-xl border-l-4  border-base-content/10 mt-8">
                  <p className="text-base-content italic text-2xl">
                     ...
                     potential health risks, so its crucial to take precautions
               ...
               <div className="mb-20">
                  ...
                  <p className="text-xl text-base-content/80">
                     ...
                     bring joy and nostalgia for years to come. However, its
